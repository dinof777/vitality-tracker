...
export async function GET(): Promise<Response> {
  ...
  const lines: string[] = [
    '# Vitality',
    '',
    `> Vitality is a mobile-first workout app — a ${exercises}-exercise illustrated library across ${equip} equipment types, with time-budgeted workout generation, routines, weekly planning, and a daily mobility habit. It's also "Vitality Pro," a white-label platform that lets gyms and personal trainers run a branded copy of the app for their clients and push workouts to the SyncroFit interval timer.`,
    '',
    ...
    `- [Welcome](${u('/welcome')}): The consumer sales pitch on its own URL — what Vitality does, how the exercise builder works, and how workouts hand off to SyncroFit.`,
