...
export const SAMPLE_EXERCISES: Exercise[] = [
  ...
  E('d0000130-0000-4000-8000-000000000000', 'Push-Up', 'Chest', 'calisthenics', 'Hands under the shoulders · lower the chest · press up'),
  E('d0000131-0000-4000-8000-000000000000', 'Wide Push-Up', 'Chest', 'calisthenics', 'Hands wider than the shoulders · elbows out · press up'),
  E('d0000132-0000-4000-8000-000000000000', 'Diamond Push-Up', 'Arms', 'calisthenics', 'Hands together under the chest · elbows tight · press'),
  E('d0000133-0000-4000-8000-000000000000', 'Pike Push-Up', 'Shoulders', 'calisthenics', 'Hips high · lower the head toward the floor · press up'),
  E('d0000134-0000-4000-8000-000000000000', 'Wall Push-Up', 'Chest', 'calisthenics', 'Hands on the wall · lean in · press back · easy variation'),
  E('d0000135-0000-4000-8000-000000000000', 'Bodyweight Squat', 'Legs', 'calisthenics', 'Feet shoulder-width · sit back · drive up tall'),
  E('d0000136-0000-4000-8000-000000000000', 'Jump Squat', 'Legs', 'calisthenics', 'Squat down · explode up · land soft'),
  E('d0000137-0000-4000-8000-000000000000', 'Bodyweight Lunge', 'Legs', 'calisthenics', 'Step forward · drop the back knee · drive up'),
  E('d0000138-0000-4000-8000-000000000000', 'Bodyweight Reverse Lunge', 'Legs', 'calisthenics', 'Step back · drop the back knee · drive through the front heel'),
  E('d0000139-0000-4000-8000-000000000000', 'Glute Bridge', 'Glutes', 'calisthenics', 'Drive through the heels · squeeze at the top'),
  E('d0000140-0000-4000-8000-000000000000', 'Single-Leg Glute Bridge', 'Glutes', 'calisthenics', 'One leg extended · hips level · squeeze · per side'),
  E('d0000141-0000-4000-8000-000000000000', 'Calf Raise', 'Calves', 'calisthenics', 'Rise onto the toes · pause · lower slow'),
  E('d0000142-0000-4000-8000-000000000000', 'Mountain Climbers', 'Core', 'calisthenics', 'High plank · drive the knees in fast · hips low'),
  E('d0000143-0000-4000-8000-000000000000', 'Burpee', 'Full Body', 'calisthenics', 'Squat · kick back · push-up · jump up'),
  E('d0000144-0000-4000-8000-000000000000', 'Bicycle Crunch', 'Core', 'calisthenics', 'Opposite elbow to knee · slow rotation'),
  E('d0000145-0000-4000-8000-000000000000', 'Sit-Up', 'Core', 'calisthenics', 'Hands light · curl all the way up · control down'),
  E('d0000146-0000-4000-8000-000000000000', 'Lying Leg Raise', 'Core', 'calisthenics', 'Legs straight · lift to vertical · lower slow · no arch'),
  E('d0000147-0000-4000-8000-000000000000', 'Flutter Kicks', 'Core', 'calisthenics', 'Legs straight · small fast alternating kicks · low back down'),
  E('d0000148-0000-4000-8000-000000000000', 'Bear Crawl', 'Full Body', 'calisthenics', 'On hands and toes · knees hovering · crawl forward'),
  E('d0000149-0000-4000-8000-000000000000', 'Inchworm', 'Full Body', 'calisthenics', 'Hinge · walk the hands out to a plank · walk back'),
];
